...
def populate_main_window(frm_main):
    ...
    lbl_radio = Label(frm_main, text="Radio")

    # Create an integer entry box where the user will enter her age.
    ent_radio = IntEntry(frm_main, width=4, lower_bound=12, upper_bound=90)
   ...
   # lbl_rate_units.grid(row=1, column=3, padx=0, pady=3)
    lbl_res.grid(     row=1, column=0, padx=(30,3), pady=3)
    lbl_cm2.grid(row=1, column=4, padx=0, pady=3)
    lbl_result.grid(      row=1, column=2, padx=3, pady=3)
