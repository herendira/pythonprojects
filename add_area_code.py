def main():
    try:
        ...
        '''the map function will call the add_area_code function once for each element 
        in the phone_numbers list, and the add_area_code 
        function will add the area code "208-" at the beginning
          of each phone number if necessary.'''
        new_numbers = list(map(add_area_code, phone_numbers))
        print(new_numbers)
        print()
       
        # for pho in phone_numbers:
        #     numeros=pho
        #     if len(numeros)==8:
...
def add_area_code(phone_numbers):

   
    if len(phone_numbers)==8:
              
              
               
        phone_numbers="208-"+phone_numbers
        #print(phone_numbers)
